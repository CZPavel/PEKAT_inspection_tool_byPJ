...
- `description_source` (`xlsx|txt|manual|generated`)
...
- Manual metadata overrides are applied for selected scripts (for example `PYZBAR_BARCODE_READER.txt`).
